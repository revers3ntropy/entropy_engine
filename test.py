...
# this is not a script, just a normal class.
# this is being used as a prefab.
class Obstacle:
...
class DeathCounterController:
    ...
    def update(self):
        ...
        print(1)
        self.text.set_text('deaths: ' + str(self.player_controller.get_deaths()))
...
camera_controller = ee.find_sprite('camera').add_component('script')
camera_controller.set_script(CameraController(ee.find_sprite('camera').get_component('body'), ee.find_sprite('player').get_component('body')))
